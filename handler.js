		...
		try {
			...
			try {
				...
				if (user) {
					...
					if (!isNumber(user.lastkalender)) user.lastkalender = 0
					if (!isNumber(user.lastwriting)) user.lastwriting = 0
					if (!isNumber(user.lastgelang)) user.lastgelang = 0
					if (!isNumber(user.lastcookie)) user.lastcookie = 0
					if (!isNumber(user.lastcake)) user.lastcake = 0
					//last Photofunia

...
let handler = async (m, {
	...
	if (!teks1) throw `masukan teksnya contoh\n ${usedPrefix+command} style2 mayaw`
	if (teks1.length > 13) throw `*hmmm?!!, teksnya kepanjangan cuy, maksimal 12 karakter\ncontoh\n\n ${usedPrefix+command} style2 Tobangado*`
	teks2 = teks2.join('|')

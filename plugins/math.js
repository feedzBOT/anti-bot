...
`.trim(), m)
	...
	global.math[id] = [
		await conn.reply(m.chat, `Berapa hasil dari *${math.str}*?\n\nTimeout: ${(math.time / 1000).toFixed(2)} detik\nJika jawaban benar kamu akan mendapatkan  Rp${Number(math.bonus).toLocaleString().replace(/,/g, '.')},-\n\nreply soalnya untuk menjawab`, m),
		math, 4,
		setTimeout(() => {
...
let modes = {
	...
	medium: [-40, 40, -20, 20, '*/+-', 40000, 4000],
	hard: [-100, 100, -70, 70, '*/+-', 60000, 6000],
	extreme: [-999999, 999999, -999999, 999999, '*/', 99999, 8000],
	impossible: [-9999999999, 9999999999, -999999, 999999, '*/', 90000, 20000],
	impossible2: [-999999999999999, 999999999999999, -999, 999, '/', 150000, 30000]
}

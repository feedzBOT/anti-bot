			...
			case 'common':
				switch (jumlah) {
					...
					case 'crate':
						...
						let cu = (_cu * 1)
						let Hcom = `
Anda telah membuka *🗃️Common crate* dan mendapatkan:${cm > 0 ? `\n💸Money: ${cm}` : ''}${ce > 0 ? `\n🎟️Exp: ${ce} *exp*` : ''}${cp > 0 ? `\n🍾Potion: ${cp} *potion*` : ''}${cc > 0 ? `\n🗃️common crate: ${cc} *crate*` : ''}${cu > 0 ? `\n🗃️Uncommon crate: ${cu} *crate*` : ''}
`.trim()
					...
					case '10':
						...
						let cu1 = (_cu1 * 1)
						let Hcom1 = `
Anda telah membuka *🗃️Common crate* dan mendapatkan:${cm1 > 0 ? `\n💸Money: ${cm1}` : ''}${ce1 > 0 ? `\n🎟️Exp: ${ce1} *exp*` : ''}${cp1 > 0 ? `\n🍾Potion: ${cp1} *potion*` : ''}${cc1 > 0 ? `\n🗃️common crate: ${cc1} *crate*` : ''}${cu1 > 0 ? `\n🗃️Uncommon crate: ${cu1} *crate*` : ''}
`.trim()
					...
					case '100':
						...
						let cu2 = (_cu2 * 1)
						let Hcom2 = `
Anda telah membuka *🗃️Common crate* dan mendapatkan:${cm2 > 0 ? `\n💸Money: ${cm2}` : ''}${ce2 > 0 ? `\n🎟️Exp: ${ce2} *exp*` : ''}${cp2 > 0 ? `\n🍾Potion: ${cp2} *potion*` : ''}${cc2 > 0 ? `\n🗃️common crate: ${cc2} *crate*` : ''}${cu2 > 0 ? `\n🗃️Uncommon crate: ${cu2} *crate*` : ''}
`.trim()
					...
					case '1000':
						...
						let cu3 = (_cu3 * 1)
						let Hcom3 = `
Anda telah membuka *🗃️Common crate* dan mendapatkan:${cm3 > 0 ? `\n💸Money: ${cm3}` : ''}${ce3 > 0 ? `\n🎟️Exp: ${ce3} *exp*` : ''}${cp3 > 0 ? `\n🍾Potion: ${cp3} *potion*` : ''}${cc3 > 0 ? `\n🗃️common crate: ${cc3} *crate*` : ''}${cu3 > 0 ? `\n🗃️Uncommon crate: ${cu3} *crate*` : ''}
`.trim()
			...
			case 'uncommon':
				switch (jumlah) {
					...
					case 'crate':
						...
						let uc = (_uc * 1)
						let Hun = `
Anda telah membuka *🗃️uncommon crate* dan mendapatkan:${um > 0 ? `\nMoney: ${um}` : ''}${ue > 0 ? `\n🎟️exp: ${ue} *exp*` : ''}${ud > 0 ? `\n💎Diamond: ${ud} *diamond*` : ''}${up > 0 ? `\n🍾Potion: ${up} *potion*` : ''}${uc > 0 ? `\n🗃️Common crate: ${uc} *crate*` : ''}${uu > 0 ? `\n🗃️Uncommon crate: ${uu} *crate*` : ''}
`.trim()
					...
					case '10':
						...
						let uc1 = (_uc1 * 1)
						let Hun1 = `
Anda telah membuka *🗃️uncommon crate* dan mendapatkan:${um1 > 0 ? `\nMoney: ${um1}` : ''}${ue1 > 0 ? `\n🎟️exp: ${ue1} *exp*` : ''}${ud1 > 0 ? `\n💎Diamond: ${ud1} *diamond*` : ''}${up1 > 0 ? `\n🍾Potion: ${up1} *potion*` : ''}${uc1 > 0 ? `\n🗃️Common crate: ${uc1} *crate*` : ''}${uu1 > 0 ? `\n🗃️Uncommon crate: ${uu1} *crate*` : ''}
`.trim()
					...
					case '100':
						...
						let uc2 = (_uc2 * 1)
						let Hun2 = `
Anda telah membuka *🗃️uncommon crate* dan mendapatkan:${um2 > 0 ? `\nMoney: ${um2}` : ''}${ue2 > 0 ? `\n🎟️exp: ${ue2} *exp*` : ''}${ud2 > 0 ? `\n💎Diamond: ${ud2} *diamond*` : ''}${up2 > 0 ? `\n🍾Potion: ${up2} *potion*` : ''}${uc2 > 0 ? `\n🗃️Common crate: ${uc2} *crate*` : ''}${uu2 > 0 ? `\n🗃️Uncommon crate: ${uu2} *crate*` : ''}
`.trim()
					...
					case '1000':
						...
						let uc3 = (_uc3 * 1)
						let Hun3 = `
Anda telah membuka *🗃️uncommon crate* dan mendapatkan:${um3 > 0 ? `\nMoney: ${um3}` : ''}${ue3 > 0 ? `\n🎟️exp: ${ue3} *exp*` : ''}${ud3 > 0 ? `\n💎Diamond: ${ud3} *diamond*` : ''}${up3 > 0 ? `\n🍾Potion: ${up3} *potion*` : ''}${uc3 > 0 ? `\n🗃️Common crate: ${uc3} *crate*` : ''}${uu3 > 0 ? `\n🗃️Uncommon crate: ${uu3} *crate*` : ''}
`.trim()

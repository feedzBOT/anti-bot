...
let handler = async (m, {
	...
	try {
		...
		let p = await (await fetch('https://tessyy-api.herokuapp.com/photooxyy?theme=ros&text=' + encodeURIComponent(text))).buffer()
...
handler.help = ['goldrose']
handler.tags = ['ph']
handler.command = /^goldrose$/i

...
let handler = async (m, {
	...
	try {
		...
		let p = await (await fetch('https://tessyy-api.herokuapp.com/photooxyy?theme=warf&text=' + encodeURIComponent(text))).buffer()
...
handler.help = ['warface2']
handler.tags = ['ph']
handler.command = /^warface2$/i
